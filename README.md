...
, which shall inherits <b>BaseImageMaskDataet</b> class, in your model training or evaluation process, please specify your own dataset class name in your train_eval_inf.config file as shown below.<br>
<pre>
[model]
